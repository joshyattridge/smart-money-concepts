...
# import test data
df = pd.read_csv("test_data/EURUSD_15M.csv")
...
class TestSmartMoneyConcepts(unittest.TestCase):
    ...
    def test_fvg(self):
        ...
        fvg_result_data = pd.read_csv("test_data/fvg_result_data.csv")
    ...
    def test_swing_highs_lows(self):
        ...
        swing_highs_lows_result_data = pd.read_csv("test_data/swing_highs_lows_result_data.csv")
    ...
    def test_bos_choch(self):
        ...
        bos_choch_result_data = pd.read_csv("test_data/bos_choch_result_data.csv")
        print("bos_choch test time: ", time.time() - start_time)
        pd.testing.assert_frame_equal(bos_choch_data, bos_choch_result_data, check_dtype=False)
    ...
    def test_ob(self):
        ...
        ob_result_data = pd.read_csv("test_data/ob_result_data.csv")
    ...
    def test_liquidity(self):
        ...
        liquidity_result_data = pd.read_csv("test_data/liquidity_result_data.csv")
    ...
    def test_previous_high_low(self):
        ...
        previous_high_low_result_data = pd.read_csv("test_data/previous_high_low_result_data.csv")
    ...
    def test_sessions(self):
        ...
        sessions_result_data = pd.read_csv("test_data/sessions_result_data.csv")
    ...
    def test_retracements(self):
        ...
        retracements_result_data = pd.read_csv("test_data/retracements_result_data.csv")
...
# def generate_results_data():
    # fvg_data = smc.fvg(df, join_consecutive=True)
    # fvg_data.to_csv("test_data/fvg_result_data.csv", index=False)

    # swing_highs_lows_data = smc.swing_highs_lows(df, swing_length=5)
    # swing_highs_lows_data.to_csv("test_data/swing_highs_lows_result_data.csv", index=False)

    # bos_choch_data = smc.bos_choch(df, swing_highs_lows_data)
    # bos_choch_data.to_csv("test_data/bos_choch_result_data.csv", index=False)

    # ob_data = smc.ob(df, swing_highs_lows_data)
    # ob_data.to_csv("test_data/ob_result_data.csv", index=False)

    # liquidity_data = smc.liquidity(df, swing_highs_lows_data)
    # liquidity_data.to_csv("test_data/liquidity_result_data.csv", index=False)

    # previous_high_low_data = smc.previous_high_low(df, time_frame="4h")
    # previous_high_low_data.to_csv("test_data/previous_high_low_result_data.csv", index=False)

    # sessions = smc.sessions(df, session="London")
    # sessions.to_csv("test_data/sessions_result_data.csv", index=False)

    # retracements = smc.retracements(df, swing_highs_lows_data)
    # retracements.to_csv("test_data/retracements_result_data.csv", index=False)
